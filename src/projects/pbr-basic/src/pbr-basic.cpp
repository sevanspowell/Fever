  ...
  private:
    ...
    void createGraphicsPipeline() {
        std::vector<char> shaderCode =
            readFile("src/projects/pbr-basic/assets/cubemap.metal");
    ...
    void createSkyboxGraphicsPipeline() {
        std::vector<char> shaderCode =
            readFile("src/projects/pbr-basic/assets/skybox.metal");
        shaderCode.push_back('\0');
    ...
    const std::string MODEL_PATH = "src/projects/pbr-basic/assets/sphere.obj";
    const std::string SKYBOX_MODEL_PATH =
        "src/projects/pbr-basic/assets/cube.obj";
...
int main(void) {
    ...
    // Create window
    SDL_Window *window =
        SDL_CreateWindow("PBR Basic", SDL_WINDOWPOS_CENTERED,
